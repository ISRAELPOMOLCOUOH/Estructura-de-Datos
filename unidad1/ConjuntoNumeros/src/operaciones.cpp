...
int operaciones::lista(int conjuntoA[],int conjuntoB[])
{
     int arc;
     int num=10;
    for(int i=0;i<num;i++){
...
int operaciones::Union(int conjuntoA[], int conjuntoB[])
{
    int arc;
    int num=10;
...
int operaciones::Interseccion(int conjuntoA[], int conjuntoB[])
{
...
int operaciones::Diferencia(int conjuntoA[], int conjuntoB[])
{
    int num=10;
...
int operaciones::PerteneceAlConjunto(int conjunto[])
{
    int num=10;
    int ban=0;
    for(int i=0; i<num; i++){
...
int operaciones::RetirarElemento(int conjunto[])
{
...
int operaciones::AnadirElemento(int conjunto[])
{
    int num=10;
